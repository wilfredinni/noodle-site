...
folder targets, response captures and assertions, JSON results, exit statuses,
secrets, and the full collection workflow. Use `noodle <command> --help` when
you need the complete options for one command.
