...
| `noodle collection run <path> [-e <env>] [--noproxy]`                             | Run every request and fail if any request fails.              |
| `noodle request create <id> --url <url> [--method <method>] [--collection <dir>]` | Create a minimal request.                                     |
| `noodle request run <id> [--collection <dir>] [-e <env>] [--noproxy]`             | Run one saved request.                                        |
