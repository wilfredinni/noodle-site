...
Updates noodle to the latest version. Homebrew installs run `brew upgrade noodle` instead.
...
Non-Homebrew installs cache the latest release check for one hour.
