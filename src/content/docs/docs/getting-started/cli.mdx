...
See [CSV/JSON iteration data](/docs/guides/collection-runner/#csv-and-json-iteration-data)
for formats, path resolution, limits, variable/cookie isolation, and result metadata.
