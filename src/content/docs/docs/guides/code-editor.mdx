---
title: Code Editor
description: Edit JSON, XML, and YAML with syntax highlighting, validation, folding, and environment-aware completion.
---

noodle includes a built-in code editor with Tree-sitter syntax highlighting
and code folding for JSON and XML bodies and YAML request files.
...
![A folded JSON response in Noodle's code editor](../../../../assets/folding.png)
...
![Environment variable suggestions in the code editor](../../../../assets/autocomplete.png)

## Technical Details

The editor registers Tree-sitter parsers for JSON, YAML, and XML. It uses
